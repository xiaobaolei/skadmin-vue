...
export default {
  ...
  mounted() {
    get().then(res => {
      this.count.newIp = parseInt(res.newIp)
      this.count.newVisits = parseInt(res.newVisits)
      this.count.recentIp = parseInt(res.recentIp)
      this.count.recentVisits = parseInt(res.recentVisits)
    })
  }
}
</script>
