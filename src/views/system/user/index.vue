    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="17" :sm="18" :md="20" :lg="20" :xl="20">
        ...
        <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
          ...
          <el-table-column v-if="checkPermission(['ADMIN','USER_ALL','USER_EDIT','USER_DELETE'])" label="操作" width="140px" align="center">
            <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      delLoading: false, sup_this: this, deptName: '', deptId: null, depts: [],
      defaultProps: {
        children: 'children',
        label: 'name'
      }
